    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_composite_profile', models.ManyToManyField(db_table='trajopt_to_trajopt_default_composite_profile', to='stats.trajoptdefaultcompositeprofile')),
                ('default_plan_profile', models.ManyToManyField(db_table='trajopt_to_trajopt_default_plan_profile', to='stats.trajoptdefaultplanprofile')),
                ('default_solver_profile', models.ManyToManyField(db_table='trajopt_to_trajopt_default_solver_profile', to='stats.trajoptdefaultsolverprofile')),
            ],
            options={
                'db_table': 'trajopt',
                'managed': True,
